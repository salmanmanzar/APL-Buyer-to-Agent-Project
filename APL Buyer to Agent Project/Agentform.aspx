<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Agentform.aspx.cs" Inherits="APL_Buyer_to_Agent_Project.Agentform" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="agentMessage" runat="server"></asp:TextBox>
        </div>
        <div class="form-group">
